...
-- Initialization
EasyExperienceBar = _G.LibStub("AceAddon-3.0"):NewAddon("EasyExperienceBar",
                                                        "AceConsole-3.0")
...
EasyExperienceBar.isPlayerMaxLevel = EasyExperienceBar.level >=
                                         EasyExperienceBar:GetMaxLevel()

EasyExperienceBar.GetNumQuestLogEntries =
    _G.C_QuestLog.GetNumQuestLogEntries or _G.GetNumQuestLogEntries
EasyExperienceBar.GetQuestIDForLogIndex =
    _G.C_QuestLog.GetQuestIDForLogIndex or
        function(i) return select(8, _G.GetQuestLogTitle(i)) end

EasyExperienceBar.IsQuestComplete = _G.C_QuestLog.IsComplete or
                                        _G.IsQuestComplete
EasyExperienceBar.QuestReadyForTurnIn = _G.C_QuestLog.ReadyForTurnIn or
                                            function() return false end
EasyExperienceBar.SetSelectedQuest = _G.C_QuestLog.SetSelectedQuest or
                                         _G.SelectQuestLogEntry
EasyExperienceBar.GetSelectedQuest = _G.C_QuestLog.GetSelectedQuest or
                                         _G.GetQuestLogSelection
...
function EasyExperienceBar:Options()
    ...
    if EasyExperienceBar.global.levelTimeText == nil then
        EasyExperienceBar.global.levelTimeText = true
    end
    if EasyExperienceBar.global.sessionTimeText == nil then
        EasyExperienceBar.global.sessionTimeText = true
    end
    if EasyExperienceBar.global.showXpHourText == nil then
        EasyExperienceBar.global.showXpHourText = true
    end
    if EasyExperienceBar.global.questRestedText == nil then
        EasyExperienceBar.global.questRestedText = true
    end
    if EasyExperienceBar.global.questXpBar == nil then
        EasyExperienceBar.global.questXpBar = true
    end
    if EasyExperienceBar.global.showMaxLevel == nil then
        EasyExperienceBar.global.showMaxLevel = false
    end
    if EasyExperienceBar.global.resetReload == nil then
        EasyExperienceBar.global.resetReload = false
    end
    if EasyExperienceBar.global.hideXpBar == nil then
        EasyExperienceBar.global.hideXpBar = true
    end
    if EasyExperienceBar.global.lockBar == nil then
    ...
    if EasyExperienceBar.global.fontOutline == nil then
        EasyExperienceBar.global.fontOutline = "THICKOUTLINE"
    end
    if EasyExperienceBar.global.bartexture == nil then
        EasyExperienceBar.global.bartexture =
            "Interface\\TargetingFrame\\UI-StatusBar"
    end
    if EasyExperienceBar.global.barWidth == nil then
        EasyExperienceBar.global.barWidth = 600
    end
    if EasyExperienceBar.global.barHeight == nil then
        EasyExperienceBar.global.barHeight = 30
    end
    ...
    local options = {
        ...
        type = 'group',
        args = {
            header1 = {type = 'header', order = 0, name = L["Information"]},
            levelTimeText = {
                type = 'toggle',
                order = 1,
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.levelTimeText
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.levelTimeText then
                        EasyExperienceBar.global.levelTimeText = false
                    else
                        EasyExperienceBar.global.levelTimeText = true
                    end
                end
            ...
            sessionTimeText = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.sessionTimeText
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.sessionTimeText then
                        EasyExperienceBar.global.sessionTimeText = false
                    else
                        EasyExperienceBar.global.sessionTimeText = true
                    end
                end
            ...
            showXpHourText = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.showXpHourText
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.showXpHourText then
                        EasyExperienceBar.global.showXpHourText = false
                    else
                        EasyExperienceBar.global.showXpHourText = true
                    end
                end
            ...
            questRestedText = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.questRestedText
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.questRestedText then
                        EasyExperienceBar.global.questRestedText = false
                    else
                        EasyExperienceBar.global.questRestedText = true
                    end
                end
            ...
            questBar = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.questXpBar
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.questXpBar then
                        EasyExperienceBar.global.questXpBar = false
                    else
                        EasyExperienceBar.global.questXpBar = true
                    end
                end
            },
            header2 = {type = 'header', order = 6, name = L["Settings"]},
            showMaxLevel = {
                type = 'toggle',
                order = 7,
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.showMaxLevel
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.showMaxLevel then
                        EasyExperienceBar.global.showMaxLevel = false
                    else
                        EasyExperienceBar.global.showMaxLevel = true
                    end
                end
            },
            resetReload = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.resetReload
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.resetReload then
                        EasyExperienceBar.global.resetReload = false
                    else
                        EasyExperienceBar.global.resetReload = true
                    end
                end
            },
            hideXPBar = {
                ...
                width = "full",
                hidden = function()
                    return not _G.StatusTrackingBarManager
                end,
                get = function(info)
                    return EasyExperienceBar.global.hideXpBar
                end,
                set = function(info, val)
            ...
            header3 = {type = 'header', order = 10, name = L["Display"]},
            lockBar = {
                type = 'toggle',
                order = 11,
                name = L["Lock Bar"],
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.lockBar
                end,
                set = function(info, val)
                    if EasyExperienceBar.global.lockBar then
                        EasyExperienceBar.global.lockBar = false
                    else
            ...
            width = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.barWidth
                end,
                set = function(info, val)
                    EasyExperienceBar.global.barWidth = val
            ...
            height = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.barHeight
                end,
                set = function(info, val)
                    EasyExperienceBar.global.barHeight = val
                    EasyExperienceBar:Resize()
                end
            },
            fontSize = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.fontSize
                end,
                set = function(info, val)
                    EasyExperienceBar.global.fontSize = val
                    EasyExperienceBar:Resize()
                end
            },
            gap = {
                ...
                order = 15,
                name = L["Gap Size"],
                desc = L["Adjust gap between Progress Bar and text"],
                min = 0,
                max = 10,
                step = 1,
                width = "full",
            ...
            outline = {
                ...
                width = "normal",
                get = function(info)
                    return EasyExperienceBar.global.fontOutline
                end,
                set = function(info, val)
            ...
            textures = {
                ...
                get = function(info)
                    ...
                    local hashtable = EasyExperienceBar.LSM:HashTable(
                                          "statusbar")
                    for i, handle in ipairs(list) do
                        values[hashtable[handle]] = handle
                    end
                ...
                set = function(info, val)
                    ...
                    EasyExperienceBar:ChangeTexture(
                        EasyExperienceBar.global.bartexture)
                end
            },
            classColour = {
                ...
                width = "full",
                get = function(info)
                    return EasyExperienceBar.global.classColour
                end,
                set = function(info, val)
                    EasyExperienceBar.global.classColour = val
                    EasyExperienceBar:ChangeTexture(
                        EasyExperienceBar.global.bartexture)
                end
            },
    ...
    EasyExperienceBar.AceConfig:RegisterOptionsTable("EasyExperienceBar",
                                                     options)
    EasyExperienceBar.AceConfigDialog:AddToBlizOptions("EasyExperienceBar",
                                                       "EasyExperienceBar")
end
...
function EasyExperienceBar.EventHandler(self, event, arg1, arg2, arg3, arg4, ...)
    ...
    if "PLAYER_ENTERING_WORLD" == event then
        if arg1 or (arg2 and EasyExperienceBar.global.resetReload) then
            ...
            EasyExperienceBar.session.lastSessionLevelTime =
                EasyExperienceBar.session.lastSessionLevelTime
            EasyExperienceBar.currentSessionLevelStart =
                EasyExperienceBar.session.startTime
        end
    elseif "PLAYER_LEVEL_UP" == event then
        EasyExperienceBar.level = arg1 or EasyExperienceBar.level
        EasyExperienceBar.isPlayerMaxLevel =
            EasyExperienceBar.level >= EasyExperienceBar:GetMaxLevel()
    ...
    elseif "UPDATE_EXPANSION_LEVEL" == event or "MAX_EXPANSION_LEVEL_UPDATED" ==
        event then
        ...
        EasyExperienceBar.isPlayerMaxLevel =
            EasyExperienceBar.level >=
                EasyExperienceBar:GetMaxLevel(maxExpLevel)

        if EasyExperienceBar.level ==
            _G.GetMaxLevelForExpansionLevel(minExpLevel) then
            EasyExperienceBar.session.startTime = _G.GetTime()
        end
    ...
    elseif "QUEST_LOG_UPDATE" == event or
        ("UNIT_QUEST_LOG_CHANGED" == event and arg1 == "player") then
        EasyExperienceBar:Update()
    elseif "PLAYER_XP_UPDATE" == event then
        local currentXP = _G.UnitXP("player") or 0
        EasyExperienceBar.session.lastXP =
            EasyExperienceBar.session.lastXP or currentXP
        local gainedXP = currentXP - EasyExperienceBar.session.lastXP

        if gainedXP < 0 then
            gainedXP = EasyExperienceBar.session.maxXP -
                           EasyExperienceBar.session.lastXP + currentXP
        end

        EasyExperienceBar.session.gainedXP =
            EasyExperienceBar.session.gainedXP + gainedXP
        EasyExperienceBar.session.lastXP = currentXP
        EasyExperienceBar.session.maxXP = _G.UnitXPMax("player") or 0
        EasyExperienceBar:Update()
    end
...
function EasyExperienceBar:OnInitialize()
    -- Saved Variables
    EasyExperienceBar.sessionDB =
        _G.LibStub("AceDB-3.0"):New("EasyExperienceDB")
    ...
    EasyExperienceBar.session.lastXP = EasyExperienceBar.session.lastXP or
                                           _G.UnitXP("player")
    EasyExperienceBar.session.maxXP = EasyExperienceBar.session.maxXP or
                                          _G.UnitXPMax("player")
    EasyExperienceBar.session.startTime =
        EasyExperienceBar.session.startTime or _G.GetTime()
    EasyExperienceBar.session.realTotalTime =
        EasyExperienceBar.session.realTotalTime or 0
    EasyExperienceBar.session.realLevelTime =
        EasyExperienceBar.session.realLevelTime or 0

    EasyExperienceBar.session.lastSessionLevelTime =
        EasyExperienceBar.session.lastSessionLevelTime or 0
    ...
    EasyExperienceBar.session.lastSessionTotalTime =
        EasyExperienceBar.session.realTotalTime
    EasyExperienceBar.currentTotalTimeStart =
        EasyExperienceBar.session.startTime
    ...
    if not EasyExperienceBar.session.location then
        if not EasyExperienceBar.global.location then
            ...
            EasyExperienceBar.MainFrame:SetPoint(
                EasyExperienceBar.global.location[1], _G.UIParent,
                EasyExperienceBar.global.location[3],
                EasyExperienceBar.global.location[4],
                EasyExperienceBar.global.location[5])
        end
    else
        EasyExperienceBar.MainFrame:SetPoint(
            EasyExperienceBar.session.location[1], _G.UIParent,
            EasyExperienceBar.session.location[3],
            EasyExperienceBar.session.location[4],
            EasyExperienceBar.session.location[5])
    end

    EasyExperienceBar:StoreLocation()

    EasyExperienceBar.BackgroundBar = EasyExperienceBar:CreateBackgroundBar(
                                          EasyExperienceBar.MainFrame)
    ...
    EasyExperienceBar.Texts = EasyExperienceBar:CreateTexts(
                                  EasyExperienceBar.ProgressBar)

    if not EasyExperienceBar.isMaxLevel then EasyExperienceBar:CreateTimer() end
...
function EasyExperienceBar:CreateTimer()
    EasyExperienceBar.UpdateTimer = _G.C_Timer.NewTicker(0.5, function()
        EasyExperienceBar.Update()
    end)
end
...
function EasyExperienceBar:RegisterEvents()
    ...
    EasyExperienceBar.MainFrame:SetScript("OnEvent",
                                          EasyExperienceBar.EventHandler)
end
...
function EasyExperienceBar:CreateProgressBar(parent)
    ...
    if EasyExperienceBar.global.classColour then
        ...
        if C_ClassColor then
            colourRgb = C_ClassColor.GetClassColor(
                            _G.select(2, _G.UnitClass("player")))
        else
    ...
    local progressBar = _G.CreateFrame("StatusBar", nil,
                                       EasyExperienceBar.MainFrame,
                                       _G.BackdropTemplateMixin and
                                           "BackdropTemplate")
    progressBar:SetPoint("CENTER", EasyExperienceBar.MainFrame, 0, 0)
    progressBar:SetSize(EasyExperienceBar.global.barWidth,
                        EasyExperienceBar.global.barHeight)
...
function EasyExperienceBar:CreateBackgroundBar(parent, scale)
    local backgroundBar = _G.CreateFrame("StatusBar", nil,
                                         EasyExperienceBar.MainFrame,
                                         _G.BackdropTemplateMixin and
                                             "BackdropTemplate")
    backgroundBar:SetPoint("CENTER", EasyExperienceBar.MainFrame, 0, 0)
    backgroundBar:SetSize(EasyExperienceBar.global.barWidth,
                          EasyExperienceBar.global.barHeight)
...
function EasyExperienceBar:CreateRestedBar(parent, scale)
    local restedBar = _G.CreateFrame("StatusBar", nil,
                                     EasyExperienceBar.MainFrame,
                                     _G.BackdropTemplateMixin and
                                         "BackdropTemplate")
    restedBar:SetPoint("CENTER", EasyExperienceBar.MainFrame, 0, 0)
    restedBar:SetSize(EasyExperienceBar.global.barWidth,
                      EasyExperienceBar.global.barHeight)
...
function EasyExperienceBar:CreateQuestBar(parent, scale)
    local questBar = _G.CreateFrame("StatusBar", nil,
                                    EasyExperienceBar.MainFrame,
                                    _G.BackdropTemplateMixin and
                                        "BackdropTemplate")
    questBar:SetPoint("CENTER", EasyExperienceBar.MainFrame, 0, 0)
    questBar:SetSize(EasyExperienceBar.global.barWidth,
                     EasyExperienceBar.global.barHeight)
...
function EasyExperienceBar:CreateTexts(frame, scale)
    ...
    levelText:SetFont(EasyExperienceBar.global.font,
                      EasyExperienceBar.global.fontSize, fontOutline)
    ...
    progressText:SetFont(EasyExperienceBar.global.font,
                         EasyExperienceBar.global.fontSize, fontOutline)
    ...
    percentText:SetFont(EasyExperienceBar.global.font,
                        EasyExperienceBar.global.fontSize, fontOutline)
...
function EasyExperienceBar:Resize()
    ...
    EasyExperienceBar.MainFrame:SetSize(EasyExperienceBar.global.barWidth,
                                        EasyExperienceBar.global.barHeight)
    EasyExperienceBar.ProgressBar:SetSize(EasyExperienceBar.global.barWidth,
                                          EasyExperienceBar.global.barHeight)
    EasyExperienceBar.BackgroundBar:SetSize(EasyExperienceBar.global.barWidth,
                                            EasyExperienceBar.global.barHeight)
    EasyExperienceBar.RestedBar:SetSize(EasyExperienceBar.global.barWidth,
                                        EasyExperienceBar.global.barHeight)
    EasyExperienceBar.QuestBar:SetSize(EasyExperienceBar.global.barWidth,
                                       EasyExperienceBar.global.barHeight)
    EasyExperienceBar.Texts.levelText:SetFont(EasyExperienceBar.global.font,
                                              EasyExperienceBar.global.fontSize,
                                              fontOutline)
    EasyExperienceBar.Texts.progressText:SetFont(EasyExperienceBar.global.font,
                                                 EasyExperienceBar.global
                                                     .fontSize, fontOutline)
    EasyExperienceBar.Texts.percentText:SetFont(EasyExperienceBar.global.font,
                                                EasyExperienceBar.global
                                                    .fontSize, fontOutline)
    EasyExperienceBar.Texts.levelTimeText:SetFont(EasyExperienceBar.global.font,
                                                  EasyExperienceBar.global
                                                      .fontSize - 1, fontOutline)
    EasyExperienceBar.Texts.sessionTimeText:SetFont(
        EasyExperienceBar.global.font, EasyExperienceBar.global.fontSize - 1,
        fontOutline)
    EasyExperienceBar.Texts.timeToLevelText:SetFont(
        EasyExperienceBar.global.font, EasyExperienceBar.global.fontSize - 1,
        fontOutline)
    EasyExperienceBar.Texts.statText:SetFont(EasyExperienceBar.global.font,
                                             EasyExperienceBar.global.fontSize -
                                                 1, fontOutline)
...
function EasyExperienceBar:ChangeFont(font)
    ...
    if font then
        EasyExperienceBar.Texts.levelText:SetFont(font,
                                                  EasyExperienceBar.global
                                                      .fontSize, fontOutline)
        EasyExperienceBar.Texts.progressText:SetFont(font,
                                                     EasyExperienceBar.global
                                                         .fontSize, fontOutline)
        EasyExperienceBar.Texts.percentText:SetFont(font,
                                                    EasyExperienceBar.global
                                                        .fontSize, fontOutline)
        EasyExperienceBar.Texts.levelTimeText:SetFont(font,
                                                      EasyExperienceBar.global
                                                          .fontSize - 1,
                                                      fontOutline)
        EasyExperienceBar.Texts.sessionTimeText:SetFont(font,
                                                        EasyExperienceBar.global
                                                            .fontSize - 1,
                                                        fontOutline)
        EasyExperienceBar.Texts.timeToLevelText:SetFont(font,
                                                        EasyExperienceBar.global
                                                            .fontSize - 1,
                                                        fontOutline)
        EasyExperienceBar.Texts.statText:SetFont(font, EasyExperienceBar.global
                                                     .fontSize - 1, fontOutline)
    end
end
...
function EasyExperienceBar:Update()
    local show = not EasyExperienceBar.isPlayerMaxLevel or
                     EasyExperienceBar.global.showMaxLevel
...
function EasyExperienceBar:CalculateValues()
    ...
    if EasyExperienceBar.global.sessionTimeText or
        EasyExperienceBar.global.showXpHourText then
        if EasyExperienceBar.session.startTime > 0 then
            EasyExperienceBar.sessionTime = currentTime -
                                                EasyExperienceBar.session
                                                    .startTime
    ...
    local allstates = {
        ...
        timeToLevelText = timeToLevel > 0 and
            EasyExperienceBar:FormatTime(timeToLevel) or "--",
        totalTime = totalTime,
        ...
        sessionTimeText = EasyExperienceBar:FormatTime(
            EasyExperienceBar.sessionTime),
        ...
        percentincomplete = totalXP > 0 and ((incompleteXP / totalXP) * 100) or
            0,
        totalpercentcomplete = totalXP > 0 and
            (((completeXP + currentXP) / totalXP) * 100) or 0
    }
    ...
    EasyExperienceBar.RestedBar:SetValue(min(
                                             allstates.percentXP + questXP +
                                                 allstates.percentrested, 100))
...
function EasyExperienceBar:UpdateQuestXP()
    ...
    for i = 1, numQ do
        ...
        if questID > 0 then
            ...
            if rewardXP > 0 then
                ...
                if EasyExperienceBar.IsQuestComplete(questID) or
                    EasyExperienceBar.QuestReadyForTurnIn(questID) then
    ...
    if currentQuestID then EasyExperienceBar.SetSelectedQuest(currentQuestID) end
...
function EasyExperienceBar:UpdateCustomTexts(state)
    ...
    if isMaxLevel then
        ...
        c2 = string.format("%s / %s (%s)",
                           _G.FormatLargeNumber(s.currentXP or 0),
                           _G.FormatLargeNumber(s.totalXP or 0),
                           _G.FormatLargeNumber(s.remainingXP or 0))
    end

    c3 = string.format("%s%%" ..
                           ((s.percentcomplete or 0) > 0 and " (%s%%)" or ""),
                       EasyExperienceBar:round(s.percentXP or 0, 1),
                       EasyExperienceBar:round(s.totalpercentcomplete or 0, 1))
    ...
    if not isMaxLevel then
        ...
        if EasyExperienceBar.global.showXpHourText then
            ...
            c4 = string.format(
                     L["Leveling in:"] .. " %s (%s%s " .. L["XP/Hour"] .. ")",
                     s.timeToLevelText or "",
                     hourlyXP > 10000 and
                         EasyExperienceBar:round(hourlyXP / 1000, 1) or
                         _G.FormatLargeNumber(hourlyXP),
                     hourlyXP > 10000 and "K" or "")
        end

        if EasyExperienceBar.global.questRestedText then
            c5 = string.format(L["Completed:"] .. " |cFFFF9700%s%%|r - " ..
                                   L["Rested:"] .. " |cFF4F90FF%s%%|r",
                               EasyExperienceBar:round(s.percentcomplete or 0, 1),
                               EasyExperienceBar:round(s.percentrested or 0, 1))
        end
    end
...
function EasyExperienceBar:StoreLocation()
    ...
    point, relativeTo, relativePoint, offsetX, offsetY =
        EasyExperienceBar.MainFrame:GetPoint()
